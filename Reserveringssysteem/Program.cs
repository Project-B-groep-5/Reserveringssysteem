...
namespace Reserveringssysteem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SelectionMenu.Make(new []{ "Reservering maken", "Reservering annuleren", "Bekijk de menukaart", "Informatie over ons", "[Voor Medewerkers]" }, new Action[] { Reservations.Reservate, CancelReservation.cancelReservation, dishMenu, InfoScherm.ShowInfo, OverviewReservations.Overview}, Logo.Welkom, "\nKies een optie\n");
